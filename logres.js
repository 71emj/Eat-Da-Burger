   ...
   IncomingMessage {
     ...
     rawHeaders:
      [ 'Host',
        ...
        'gzip, deflate, br',
        'Accept-Language',
        'en-US,en;q=0.9,ja;q=0.8,zh-TW;q=0.7,zh;q=0.6,zh-CN;q=0.5',
        'Cookie',
     ...
     _parsedOriginalUrl:
      Url {
        ...
        href: '/eat-da-burger',
        _raw: '/eat-da-burger' },
     route: Route { path: '/eat-da-burger?', stack: [Array], methods: [Object] } },
  locals: {},
